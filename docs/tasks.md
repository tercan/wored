...
- Playlist penceresi istenildiğinde player penceresine pinlenip tek pencere gibi hareket edebilecek
...
- [x] ISS-026 Playlist pinleme davranışını netleştirme ve toggle
...
- [x] Mini player ve menü bar akışı bozulmadan çalışıyor
...
- [x] Playlist pinleme tek pencere gibi hareket ediyor
